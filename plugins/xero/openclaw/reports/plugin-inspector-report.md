...
| ------------- | -------- | ------------ | ----- | ----------------------------------------------------- | ------------------ |
| openclaw-xero | high     | dynamic-tool | -     | registerCli, registerGatewayMethod, registerHttpRoute | tools              |
...
| ------------- | ---------------------- | ----- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------- |
| openclaw-xero | seam-inventory         | log   | observed 0 hooks, 3 registrations, and 1 manifest contracts                           | registration:registerCli, registration:registerGatewayMethod, registration:registerHttpRoute, manifestContract:tools | -             |
| openclaw-xero | hook-names-present     | log   | all observed hooks exist in the target OpenClaw hook registry                         | -                                                                                                                    | -             |
| openclaw-xero | api-registrars-present | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder      | registerCli, registerGatewayMethod, registerHttpRoute                                                                | -             |
| openclaw-xero | sdk-exports-present    | log   | all observed plugin SDK imports exist in target OpenClaw package exports              | openclaw/plugin-sdk/tool-plugin                                                                                      | -             |
| openclaw-xero | package-metadata       | log   | selected package metadata for plugin contract checks                                  | package.json, @arcforgelabs/openclaw-xero, version:0.3.0                                                             | -             |
| openclaw-xero | declarative-contracts  | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                                                                                | -             |
