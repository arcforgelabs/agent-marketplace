...
const customFields = Type.Optional(Type.Array(Type.Object({
    id: Type.String(),
    value: Type.Unknown(),
}, { additionalProperties: false })));
...
export default defineToolPlugin({
    ...
    description: "Unofficial HighLevel CRM tools for one sub-account: contacts, conversations, opportunities, calendars, workflows, and more.",
    configSchema,
    tools: (tool) => [
        tool({
            name: "ghl_status",
        ...
        tool({
            ...
            description: "Search, get, upsert, update, tag, or delete contacts in the configured HighLevel location. Upsert dedupes by email/phone.",
            parameters: Type.Object({
                action: actionSchema(["search", "get", "upsert", "update", "add_tags", "remove_tags", "delete"], "Contact operation to run."),
        ...
        tool({
            ...
            description: "List workflows and enroll or unenroll a contact. Workflow construction is not supported by this plugin.",
            parameters: Type.Object({
