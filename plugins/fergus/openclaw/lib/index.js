...
const configSchema = Type.Object({
    apiToken: Type.Union([Type.String({ minLength: 1 }), secretRef], {
        description: "Fergus company Personal Access Token. Prefer a host-managed SecretRef including source store.",
    }),
...
export default defineToolPlugin({
    ...
    description: "Unofficial Fergus trades job-management tools: jobs, quotes, calendar, customers, stock, and more. Not affiliated with Fergus.",
    configSchema,
    tools: (tool) => [
        tool({
            name: "fergus_status",
            label: "Fergus Status",
            description: "Read-only probe: /version, /users/me, /company, and the local 100/min company rate-limit governor.",
        ...
        tool({
            name: "fergus_jobs",
            label: "Fergus Jobs",
            description: "Jobs and phases: list/get/create/update/finalise/hold/resume/financial plus phase CRUD, void, readyForInvoice, reopen.",
        ...
        tool({
            name: "fergus_quotes",
            label: "Fergus Quotes",
            description: "Quotes: list/get/create/update/version plus publish, markAsSent, markAsViewed, accept, decline, void, totals.",
            parameters: Type.Object({
                action: actionSchema([
                    "list",
                    "list_for_job",
        ...
        tool({
            ...
            description: "Calendar events: list/get/create/update/delete. Update is POST /calendarEvents/{id}. eventType JOB_PHASE | QUOTE | ESTIMATE | OTHER.",
            parameters: Type.Object({
                action: actionSchema(["list", "get", "create", "update", "delete"], "Calendar operation to run. Writes require an explicit action."),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["list", "get", "create", "update", "delete"], "Customer operation to run. Writes require an explicit action."),
                customerId: Type.Optional(Type.Union([Type.String(), Type.Number()])),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["list", "get", "create", "update", "archive", "restore"], "Site operation to run. Writes require an explicit action."),
                siteId: Type.Optional(Type.Union([Type.String(), Type.Number()])),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["list", "get", "create", "update"], "Contact operation to run. Writes require an explicit action."),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["list", "me", "get", "update"], "User operation to run. Writes require an explicit action."),
                userId: Type.Optional(Type.Union([Type.String(), Type.Number()])),
                firstName: Type.Optional(Type.String()),
                lastName: Type.Optional(Type.String()),
        ...
        tool({
            name: "fergus_notes",
            label: "Fergus Notes",
            description: "Notes: list/create/update. entityName is job | customer | customer_invoice | quote | site | task | enquiry | works_order.",
            parameters: Type.Object({
                action: actionSchema(["list", "create", "update"], "Note operation to run. Writes require an explicit action."),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["list", "get", "create", "update", "delete", "complete", "reopen"], "Task operation to run. Writes require an explicit action."),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["list", "get", "create"], "Enquiry operation to run. Writes require an explicit action."),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["list", "list_for_phase", "create", "update", "delete", "used"], "Stock operation to run. Writes require an explicit action."),
                jobPhaseId: Type.Optional(Type.Union([Type.String(), Type.Number()])),
        ...
        tool({
            ...
            parameters: Type.Object({
                action: actionSchema(["search", "list", "get", "list_items", "get_item", "list_tiers", "get_tier"], "Price book operation to run."),
