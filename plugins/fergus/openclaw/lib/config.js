...
export function resolveConfig(config) {
    ...
    if (typeof raw !== "string") {
        throw new Error("Fergus apiToken is an unresolved SecretRef; store it as a SecretRef and let the host resolve it.");
    }
...
export function capLimit(value, fallback = 10, max = 100) {
